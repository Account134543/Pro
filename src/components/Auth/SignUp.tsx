            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[500px] rounded bg-white px-6 py-10 shadow-three dark:bg-dark sm:p-[60px]">
                ...
                <div className="mb-8 flex items-center justify-center">
                  <span className="hidden h-[1px] w-full max-w-[65px] bg-stroke dark:bg-stroke-dark sm:block"></span>
                    ...
                    >
                      <div className="relative">
                        <input
                          ...
                          className="sr-only"
                        />
                        <div className="box mr-4 mt-0.5 flex h-5 w-5 items-center justify-center rounded border border-stroke dark:border-stroke-dark">
